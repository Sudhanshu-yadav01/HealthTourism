...
const Home = ({ selectedCategory, selectedCountry }) => {
  ...
  // Filter products when selectedCountry or selectedCategory changes
  useEffect(() => {
  ...
  }, [selectedCountry, selectedCategory, products])

  if (isError) {
    return <h2 style={{ padding: "10rem", textAlign: "center", fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>Something went wrong...</h2>
  }
        ...
        {filteredProducts.length > 0 ? (
                    ...
                    <div style={{ 
                      ...
                      <div style={{ 
                        ...
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "6px" }}>
                          <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M3 12H21" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M12 3C14.5013 5.76254 15.9228 9.29451 16 13C15.9228 16.7055 14.5013 20.2375 12 23C9.49872 20.2375 8.07725 16.7055 8 13C8.07725 9.29451 9.49872 5.76254 12 3Z" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        {product.country}
                      </div>
                      <span
                    ...
                    <div style={{
                      ...
                      >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "6px" }}>
                          <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill="#43a047"/>
          ...
          <div style={{ 
            ...
            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ margin: "0 auto 20px" }}>
              <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#43a047" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <h3 style={{ 
              ...
              color: "#2e2e2e",
              marginBottom: "8px"
            }}>No hospitals match your filter criteria</h3>
            <p style={{ 
              fontSize: "16px", 
              color: "#666",
              maxWidth: "400px",
              margin: "0 auto"
            }}>Try changing your filters or view all hospitals</p>
          </div>
        )}
      </div>
